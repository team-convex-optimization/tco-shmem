...
struct tco_shmem_data_plan
{
    ...
    uint16_t waypts[TCO_PLAN_WAYPTS_N][2]; /* Each element contains x and y coordiantes of the waypoint on a frame */
};
...
struct tco_shmem_data_training
{
    ...
    uint8_t video[TCO_FRAME_HEIGHT][TCO_FRAME_WIDTH]; /* Grayscale camera feed from the simulator */
};
